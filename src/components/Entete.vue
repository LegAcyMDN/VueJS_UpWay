    ...
    <div id="top-barre">
      ...
      <div id="input-search">
        <div id="input-container">
          <input type="text" name="recherche" id="search" placeholder="Rechercher par marque, modèle...">

          <button id="cancel-search">
            <svg width="14" height="14" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="black">
